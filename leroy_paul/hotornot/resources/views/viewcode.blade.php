        ...
        <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>program language:</td><td colspan=2>{{ $code->program_language }}</td>
                        </tr>

                        <tr>
                            <td>IDE:</td><td colspan=2>{{ $code->IDE }}</td>
                        </tr>

                        <tr>
                            <td>description:</td><td colspan="2" height = "200">{{ $code->description }}</td>
                        </tr>
                        <tr></tr>
